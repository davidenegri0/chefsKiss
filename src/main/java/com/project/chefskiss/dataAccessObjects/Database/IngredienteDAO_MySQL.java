...
public class IngredienteDAO_MySQL implements IngredienteDAO {
    ...
    public Ingrediente findByName(String Nome_Ingrediente) {
        ...
        try {
            String SQLQuery = "SELECT * FROM ingrediente WHERE Nome_Ingrediente LIKE ?";
    ...
    public List<Ingrediente> getAllIngredients() {
        ...
        try{
            String SQLQuery = "SELECT * FROM ingrediente ORDER BY Nome_Ingrediente";
    ...
    public List<String> getAllAllergeni(){
        ...
        try{
            String SQLQuery = "SELECT DISTINCT Gruppo_Allergenico FROM ingrediente";
    ...
    public List<Ingrediente> findByGruppo(String Gruppo_Allergenico) {
        ...
        try{
            String SQLQuery = "SELECT * FROM ingrediente WHERE Gruppo_Allergenico LIKE ?";
