...
public class SedeDAO_MySQL implements SedeDAO {
    ...
    public Sede create(String Coordinate, String Via, String Citta, Integer Posti_Disponibili, Ristorante Ristorante, List<Piatto> Piatti) {
        ...
        try{
            String SQLQuery_sede = "INSERT INTO boru5sh3eoe2vtbznsll.sede (Coordinate, Via, Citta, Posti_Disponibili, ID_Ristorante) VALUES (?,?,?,?,?)";
            String SQLQuery_servito_in = "INSERT INTO boru5sh3eoe2vtbznsll.servito_in (ID_Piatto, Coordinate) VALUES (?,?)";
    ...
    public Sede create(String Coordinate, String Via, String Citta, Integer Posti_Disponibili, Integer ID_Ristorante) {
        ...
        try{
            String SQLQuery = "INSERT INTO boru5sh3eoe2vtbznsll.sede(Coordinate, Via, Citta, Posti_Disponibili, ID_Ristorante) " +
                    "VALUES (?, ?, ?, ?, ?)";
    ...
    */
    ...
    public void update(Sede sede) {
        ...
        try {
            String SQLQuery =
                    "UPDATE boru5sh3eoe2vtbznsll.sede " +
    ...
    public void delete(Sede sede) {
        ...
        try{
            String SQLQuery = "UPDATE boru5sh3eoe2vtbznsll.sede SET Deleted = 'Y' WHERE Coordinate = ?";
    ...
    public Sede findByPosition(String Via, String Citta) {
        ...
        try{
            String SQLQuery =
                    "SELECT * " +
                    "FROM boru5sh3eoe2vtbznsll.sede " +
                    "WHERE Via = ? " +
                    "AND Citta = ? " +
                    "AND Deleted = 'N'";
    ...
    public List<Sede> findByRistorante(String nomeRistorante) {
        ...
        try{
            String SQLQuery =
                    ...
                    "FROM boru5sh3eoe2vtbznsll.sede " +
                    "NATURAL JOIN boru5sh3eoe2vtbznsll.ristorante " +
    ...
    public List<Sede> findByPiatto (Piatto piatto){
        ...
        try{
            String SQLQuery =
                    "SELECT Coordinate, Via, Citta, Posti_Disponibili, ID_Ristorante, Deleted " +
                    "FROM boru5sh3eoe2vtbznsll.servito_in " +
                    "NATURAL JOIN boru5sh3eoe2vtbznsll.sede " +
                    "WHERE ID_Piatto = ? " +
                    "AND sede.Deleted = 'N'";
        ...
        try{
            String SQLQuery =
                    "SELECT s.*, r.ID_Ristorante, r.Nome_Ristorante, AVG(v.Voto) AS Media " +
                            "FROM boru5sh3eoe2vtbznsll.ristorante AS r NATURAL JOIN boru5sh3eoe2vtbznsll.sede AS s LEFT JOIN boru5sh3eoe2vtbznsll.valuta AS v ON s.Coordinate = v.Coordinate " +
    ...
    public List<Sede> getAll() {
        ...
        try {
            String SQLQuary = "SELECT s.*, AVG(v.Voto) as Media " +
                    "FROM boru5sh3eoe2vtbznsll.sede s " +
