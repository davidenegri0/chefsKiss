...
public class PiattoDAO_MySQL implements PiattoDAO {
    ...
    public Piatto create(String Nome_Piatto, String Preparazione, User Utente, Blob img)
    {
        ...
        try {
            String SQLQuery =
                    "INSERT INTO boru5sh3eoe2vtbznsll.piatto(Nome_Piatto, Data_Upload, Preparazione, CF, Foto_Piatto) " +
                    "VALUES (?, ?, ?, ?, ?) ";
            ...
            SQLQuery = "SELECT * FROM boru5sh3eoe2vtbznsll.piatto WHERE Nome_Piatto = ?";
    ...
    public void update(Piatto piatto) {
        ...
        try {
            String SQLQuery =
                    "UPDATE boru5sh3eoe2vtbznsll.piatto " +
                    "SET Nome_Piatto = ?, " +
                    "Preparazione = ?, " +
                    "CF = ?, " +
                    "Foto_Piatto = ? " +
    ...
    public void delete(Piatto piatto) {
        ...
        try{
            String SQLQuery = "UPDATE boru5sh3eoe2vtbznsll.piatto SET Deleted = 'Y' WHERE ID_Piatto = ?";
            String SQLQuery2 = "DELETE FROM boru5sh3eoe2vtbznsll.servito_in WHERE ID_Piatto = ?";
            ...
            String Verifica = "SELECT Deleted FROM boru5sh3eoe2vtbznsll.piatto WHERE ID_Piatto = ?";
    ...
    public void addPiattoinSede (Piatto piatto, Sede sede){
        ...
        try{
            String SQLQuery =
                    "INSERT INTO boru5sh3eoe2vtbznsll.servito_in (ID_Piatto, Coordinate) " +
                    "VALUES (?,?)";
    ...
    public List<Piatto> findByName(String Nome_Piatto) {
        ...
        try {
            String SQLQuery =
                    ...
                    "FROM boru5sh3eoe2vtbznsll.piatto p " +
                    "LEFT JOIN boru5sh3eoe2vtbznsll.recensisce r on p.ID_Piatto = r.ID_Piatto " +
    ...
    public List<Piatto> findByName(String Nome_Piatto, List<String> Allergeni) {
        ...
        try {
            String SQLSubQuery =
                    ...
                    "FROM boru5sh3eoe2vtbznsll.contiene AS c " +
    ...
    public List<Piatto> findBySede(Sede Sede) {
        ...
        try {
            String SQLQuery =
                    ...
                    "AND p.Deleted = 'N'" +
                    "GROUP BY p.ID_Piatto";
            String SQLQuery2 = "SELECT * FROM boru5sh3eoe2vtbznsll.servito_in WHERE Coordinate = ?";
            query = conn.prepareStatement(SQLQuery);
